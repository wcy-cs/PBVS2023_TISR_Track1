...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--add_mean', type=int, default=0)
        parser.add_argument('--gcm_model', type=str, default='gcm')
        ...
        # args.test_only and args.tlc_enhance:
        parser.add_argument('--test_only',  type=str2bool, default=False)
        parser.add_argument('--tlc_enhance', type=str2bool, default=False)
        ...
        parser.add_argument('--writer_name', type=str, default='default')
